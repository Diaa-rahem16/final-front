...
const ClientNav = () => {
  ...
  return (
    <header id="client-nav">
        ...
        <ul className="left">
          <li>
            <Link to="/client/search">
              <img src="../../public/icons/img_rewind.svg" alt="Search" />
            </Link>
          </li>
          <li>
            <Link to="/client/cart">
              <img src="../../public/icons/bag.svg" alt="Cart" />
            </Link>
          </li>
      ...
      <CategoryList />
      <div className="w-full h-8 text-text font-bold bg-[#FFD700] flex justify-center items-center leading-tight">
